...
export default function RegisterPageComponent() {
  ...
  return (
    <div className="h-screen bg-[#050608] flex flex-col relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col h-screen">
        ...
        <div className="flex flex-col lg:flex-row flex-1 max-w-[1240px] mx-auto w-full px-4 sm:px-6 lg:px-12 gap-4 lg:gap-20 items-center lg:items-start justify-start pb-4 overflow-hidden">
          <div className="w-full lg:w-[52%] flex flex-col items-center sm:items-start">
            <div className="relative w-full max-w-xl mx-auto lg:ml-0 hero-tilt-perspective hidden sm:block">
              ...
              <div className="mt-14 w-full flex flex-col items-center sm:items-start">
                <div className="mb-4 text-center sm:text-left h-20">
          ...
          <div className="w-full lg:w-[40%] relative">
            ...
            <div className="bg-[#0b0c0f]/60 border border-white/10 backdrop-blur-xl shadow-2xl rounded-[20px] p-6 sm:p-7 w-full relative z-10 transition-all">
