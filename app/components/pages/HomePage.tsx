        ...
        brandLabel={
          ...
          >
            ...
            <div className="flex items-center justify-center w-full h-full rounded-[59.79px] relative z-10">
              <EZTestLogo width={20} height={20} patternId="pattern-home-logo" />
            </div>
          </div>
        }
        ...
        breadcrumbs={
          <>
            ...
            >
              ...
              />
              <span className="relative z-30 flex items-center gap-1 sm:gap-2" style={{
                background: 'linear-gradient(90deg, #F3F3F3 0%, #5C5C5C 100%)',
                WebkitBackgroundClip: 'text',
                backgroundClip: 'text',
                color: 'transparent',
              }}>
                <span className="hidden lg:inline">Self host with</span>
                <Image
                  src="/houseoffoss.jpg"
                  alt="House Of FOSS"
                  width={24}
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            >
              ...
              >
                ...
                />
                <span 
                  className="relative z-10 px-2 sm:px-4 py-2 transition-colors cursor-pointer"
                  style={{
                    fontFamily: 'Inter',
                    fontWeight: 500,
                    fontSize: 'clamp(12px, 2vw, 14px)',
