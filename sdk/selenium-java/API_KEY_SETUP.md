# Where to Set API Key (JWT Token)

This guide shows all the places where you can set your EZTest API key. 

**Note:** The API key is actually a **JWT token** that you get when you log in to EZTest. You can extract it from your browser session or get it programmatically.
