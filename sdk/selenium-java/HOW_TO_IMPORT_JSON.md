...
2. ✅ **EZTest credentials** - JWT token from login
3. ✅ **Project ID** - Your EZTest project CUID (from URL)
...
$env:EZTEST_API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."  # Your JWT token
...
public class SimpleJsonImport {
    public static void main(String[] args) {
        ...
        try {
            ...
            String testRunId = importer.importFromFile("samples/sample-report.json");
...
- Each result must have `test_name` and `status`
...
- **Sample JSON**: [samples/sample-report.json](samples/sample-report.json)
...
- ✅ **Get JWT Token**: See [GET_JWT_TOKEN.md](GET_JWT_TOKEN.md)
