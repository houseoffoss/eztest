...
- You can use different Project IDs for different test classes (see [MULTIPLE_PROJECTS.md](MULTIPLE_PROJECTS.md))
...
2. ✅ Continue with the [USER_GUIDE.md](USER_GUIDE.md) to complete setup
...
- See [USER_GUIDE.md](USER_GUIDE.md) for complete setup instructions
- Check [GET_JWT_TOKEN.md](GET_JWT_TOKEN.md) for authentication setup
- Review [MULTIPLE_PROJECTS.md](MULTIPLE_PROJECTS.md) for using multiple projects
