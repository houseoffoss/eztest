  ...
  return (
    <input
      ...
      className={cn(
        ...
        variant === "glass"
          ? "bg-[#0f0f12]/70 border-white/15 text-white/90 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.08)] focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-primary/40"
