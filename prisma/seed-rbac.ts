...
export async function seedRBAC() {
  ...
  const permissions = [
    ...
    {
      name: "dropdowns:manage",
      description: "Manage dropdown options (create, update, delete)",
    },

    // Agent testing permissions
    {
      name: "agent_testing:read",
      description: "View agent test configurations and runs",
    },
    {
      name: "agent_testing:create",
      description: "Create agent test configurations",
    },
    {
      name: "agent_testing:update",
      description: "Update agent test configurations",
    },
    {
      name: "agent_testing:delete",
      description: "Delete agent test configurations",
    },
    { name: "agent_testing:execute", description: "Run agent tests" },
  ];
  ...
  const pmPermissions = permissionRecords.filter((perm) =>
    [
      ...
      "dropdowns:manage",
      "agent_testing:read",
      "agent_testing:create",
      "agent_testing:update",
      "agent_testing:delete",
      "agent_testing:execute",
    ].includes(perm.name),
  );
  await prisma.rolePermission.createMany({
  ...
  console.log(
    "    ✅ TESTER: Full access to test operations and defects (cannot create, update, or delete projects or manage members)",
  );
